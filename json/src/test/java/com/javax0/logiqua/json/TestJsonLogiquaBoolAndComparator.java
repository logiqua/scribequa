...
public class TestJsonLogiquaBoolAndComparator {
    ...
    void testAndMultipleArguments() {
        ...
        test(false, "{\"and\" : [ false, true, true] }");

        // Three arguments - one false in middle
        test(false, "{\"and\" : [ true, false, true] }");
        ...
        test(false, "{\"and\" : [ true, true, false, true] }");
    }
    ...
    void testOrMultipleArguments() {
        // Three arguments - all true
        test(true, "{\"or\" : [ true, true, true] }");

        // Three arguments - one true at start
        test(true, "{\"or\" : [ true, false, false] }");
    ...
    void testComplexLogicalExpressions() {
        ...
        test(false, "{\"!\" : [ {\"and\" : [ true, true]} ] }");

        test(true, "{\"!\" : [ {\"and\" : [ true, false]} ] }");

        // AND with comparisons
        test(true, "{\"and\" : [ {\"<\" : [ 1, 5] }, {\"<\" : [ 3, 7] } ] }");

        // OR with comparisons
        test(true, "{\"or\" : [ {\"<\" : [ 5, 3] }, {\"<\" : [ 3, 5] } ] }");
